  ...
  return (
    <div className="min-h-screen bg-white text-[#131e29] p-4">
      ...
      <div className="mt-6 flex items-center justify-between gap-3">
        ...
        <button
          type="button"
          className="rounded-xl px-3 py-2 text-sm font-semibold transition border bg-[#131e29] hover:opacity-90 border-[#131e29] text-white flex items-center gap-2"
          onClick={loadAll}
          disabled={loading}
        >
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="rounded-2xl border border-black/10 bg-white p-4">
          <div className="text-xs text-[#131e29]/60">Ganancias (videos + referidos)</div>
